...
const PageDrawer = (props) => {
  ...
  return (
    <span>
      <Icon size={32} type="icon-baseline-menu-px" onClick={onDrawerVisibleChange(setVisible, true)} />
      {
        visible &&
        <Drawer
          open
            ...
            <div>
              ...
              }
              {
                ...
                <div
                  ...
                  className={`zerion-drawer-listitem ${pagekey === 'overview' ? ' zerion-drawer-active-listitem' : ''}`}
                >
                  <Icon type="icon-eye" active={pagekey === 'overview'} />
              ...
              }
              {
                ...
                <div
                  ...
                  className={`zerion-drawer-listitem ${pagekey === 'history' ? ' zerion-drawer-active-listitem' : ''}`}
                >
                  <Icon type="icon-lishi" active={pagekey === 'history'} />
              ...
              <div
                onClick={() => {
                  setVisible(false);
                  window.location.hash = `#/invest/${id}`;
                }}
                className={`zerion-drawer-listitem ${pagekey === 'invest' ? ' zerion-drawer-active-listitem' : ''}`}
              >
                <Icon type="icon-touzilicai" active={pagekey === 'invest'} />
              ...
              <div className="zerion-drawer-listitem">
                <Icon type="icon-yuyan1" />
                <span>{labelTran('语言')}</span>
              </div>
              <div className="zerion-drawer-listitem">
                <Icon type="icon-theme" />
